...
export function genHeaderIds(pid: BigInt, headerIdsBigInt: Array<BigInt>): Array<string> {
...
export function genCommandIds(pid: BigInt, commandIdsBigInt: Array<BigInt>): Array<string> {
