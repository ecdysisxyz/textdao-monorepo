...
import {ITextDAOEvents} from "src/interfaces/ITextDAOEvents.sol";
import {ITextDAOErrors} from "src/interfaces/ITextDAOErrors.sol";

contract ${facade.name} is Schema, ITextDAOEvents, ITextDAOErrors {\n`;
