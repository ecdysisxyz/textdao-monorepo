...
// export function handleHeaderCreated(event: HeaderProposedEvent): void {
...
//     header.save();
// }
// export function handleCommandCreated(event: CommandProposedEvent): void {
...
// export function handleHeaderScored(event: HeaderScored): void {}
// export function handleCmdScored(event: CmdScored): void {}
